-- Produção 1.5.0: natureza da compra + registro no changelog
-- Idempotente: pode ser executado múltiplas vezes.

BEGIN;

-- 1) Coluna natureza em compras
...
ALTER TABLE public.compras
  ADD CONSTRAINT compras_natureza_check
  CHECK (natureza IS NULL OR natureza IN ('material','servico','equipamento'));
