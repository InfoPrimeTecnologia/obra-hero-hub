-- =====================================================================
-- MESTRE 360 — v1.2.0 (Fase 2 · Sprint 1)
-- Dashboard executivo + Alertas configuráveis de estouro de orçamento
--
...
-- 2) Registro no changelog (app_releases)
...
VALUES (
  ...
  '[
    ...
    {"tipo":"fix","texto":"Corrigidas queries do dashboard que referenciavam colunas inexistentes (data_vencimento → vencimento)"}
  ]'::jsonb,
  now()
)
